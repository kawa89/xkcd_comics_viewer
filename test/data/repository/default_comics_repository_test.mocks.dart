...
// in xkcd_comics_viewer/test/data/repository/default_comics_repository_test.dart.
// Do not manually edit this file.

import 'dart:async' as _i4;

import 'package:mockito/mockito.dart' as _i1;
import 'package:xkcd_comics_viewer/data/local/local_comic_data_source.dart' as _i5;
import 'package:xkcd_comics_viewer/data/remote/remote_comic_data_source.dart' as _i3;
...
/// A class which mocks [RemoteComicDataSource].
///
/// See the documentation for Mockito's code generation for more information.
class MockRemoteComicDataSource extends _i1.Mock implements _i3.RemoteComicDataSource {
  MockRemoteComicDataSource() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<_i2.Comic?> getComic(int? id) =>
      (super.noSuchMethod(Invocation.method(#getComic, [id]), returnValue: Future<_i2.Comic?>.value(_FakeComic())) as _i4.Future<_i2.Comic?>);

  @override
  _i4.Future<_i2.Comic?> getLatestComic() =>
      (super.noSuchMethod(Invocation.method(#getLatestComic, []), returnValue: Future<_i2.Comic?>.value(_FakeComic())) as _i4.Future<_i2.Comic?>);
}

/// A class which mocks [LocalComicDataSource].
///
/// See the documentation for Mockito's code generation for more information.
class MockLocalComicDataSource extends _i1.Mock implements _i5.LocalComicDataSource {
  MockLocalComicDataSource() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i4.Future<void> saveComic(_i2.Comic? comic) =>
      (super.noSuchMethod(Invocation.method(#saveComic, [comic]), returnValue: Future<void>.value(null), returnValueForMissingStub: Future.value())
          as _i4.Future<void>);
}
